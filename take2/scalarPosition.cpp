...
void PositionTracking::updatePosition(float accel, int dt, float voltage) {
...
float PositionTracking::voltageToSpeed(float voltage) {
    // standin only for now. 
    // returns 0.00134 to represent 1.34 meters per second or 3 mph, a normal walking speed, converted to meters per millisecond.
    return 0.00134;
}
