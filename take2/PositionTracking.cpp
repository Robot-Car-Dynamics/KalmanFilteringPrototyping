...
*/
PositionTracking::PositionTracking(int posX = 0, int velX = 0, int dt) {
    stateVector << posX, velX; // initial position and velocity are 0 by default
    uncertainty << 1, 0,
                  0, 1; // initial uncertainty is small
    
    stateTransition << 1, dt,
                       0, 1; // change this. It's wrong
}
